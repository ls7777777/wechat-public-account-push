export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx12a028b43387fcf3",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "4bf0e8a352fa3f98147b8784e1a22de9",
  ...
  USERS: [
    {
      ...
      id: "ogbtv5y5ZC1mTz1UjKNzAf77zCc4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "nhw22AZrVS_ZEakDFHu6viqJODjab6h2-wZizc0mrdY",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "烟台",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "小笨蛋", "year": "2003", "date": "09-13"},
      ],
    },
    {
      name: "",
